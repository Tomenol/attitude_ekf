...
class gyroscope_preprocessor():
    def __init__(self, gyroscope_std_deviation_1, gyroscope_bias_1, gyroscope_std_deviation_2, gyroscope_bias_2, f0=5):
        ...
        self.virtual_gyroscope_std_deviation = (gyroscope_std_deviation_1 * gyroscope_std_deviation_2) / np.sqrt(gyroscope_std_deviation_1**2 + gyroscope_std_deviation_2**2)
    ...
    def process_measurements(self, gyroscope_measurement_1, gyroscope_measurement_2, dt):
        ...
        return self.gyroscope_prefilter.filter_measurements(self.lpf.out(fused_measurements, dt), dt)
...
class imu_sensor_preprocessor():
    def __init__(self, sensor_std_deviation_1, sensor_bias_1, sensor_std_deviation_2, sensor_bias_2):
        ...
        self.virtual_sensor_std_deviation = (self.sensor_std_deviation_1 * self.sensor_std_deviation_2) / np.sqrt(self.sensor_std_deviation_1**2 + self.sensor_std_deviation_2**2)
